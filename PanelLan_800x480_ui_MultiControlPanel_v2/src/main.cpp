...
void loop() { 
  ...
  // if (previousScreenOnFocus != screenOnFocus)
  // {   
  //   //screenLastOnFocus == 1? : screenOnFocus;
  //   Serial.print("screenOnFocus: ");
  //   Serial.print(screenOnFocus, DEC);
  //   Serial.print("    ");
  //   Serial.print("screenLastOnFocus: ");
  //   Serial.println(screenLastOnFocus, DEC);    
  //   previousScreenOnFocus == screenOnFocus;
  // }  
}
