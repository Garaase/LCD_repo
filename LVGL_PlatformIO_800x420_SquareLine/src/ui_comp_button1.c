...
lv_obj_t * ui_Button1_create(lv_obj_t * comp_parent)
{
    ...
    lv_obj_set_width(cui_Button1, 150);
    lv_obj_set_height(cui_Button1, 50);
    lv_obj_set_x(cui_Button1, -7);
    lv_obj_set_y(cui_Button1, -9);
    ...
    lv_obj_set_style_text_color(cui_Button1, lv_color_hex(0x860202), LV_PART_MAIN | LV_STATE_DEFAULT);
